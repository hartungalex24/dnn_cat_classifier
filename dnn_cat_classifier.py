...
IMPLEMENT HELPER FUNCTIONS in dnn_app_utils_v3
'''
...
# Retrain model on 4 layer neural network
...
# TEST MODEL ON RANDOM INPUT IMAGE
my_image = "tiger-cat-1.jpg" # change this to the name of your image file
